                ...
                <div className="fixed-bottom" style={divStyle}>  
                    <ul className="nav justify-content-center">
                        ...
                        <li className="nav-item">
                            ...
                            <svg class="bi bi-card-heading" width="2em" height="2em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <li className="nav-item">
                            ...
                            <svg class="bi bi-card-image" width="2em" height="2em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                <path fill-rule="evenodd" d="M14.5 3h-13a.5.5 0 00-.5.5v9a.5.5 0 00.5.5h13a.5.5 0 00.5-.5v-9a.5.5 0 00-.5-.5zm-13-1A1.5 1.5 0 000 3.5v9A1.5 1.5 0 001.5 14h13a1.5 1.5 0 001.5-1.5v-9A1.5 1.5 0 0014.5 2h-13z" clip-rule="evenodd"/>
                        ...
                        <li className="nav-item">
                            ...
                            <svg class="bi bi-chat-quote-fill" width="2em" height="2em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
